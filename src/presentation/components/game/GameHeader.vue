...
<template>
  <header class="game-header grid shrink-0 grid-cols-[3rem_1fr_3rem] items-center gap-1 rounded-md border border-stone-300/10 bg-transparent px-0 py-0">
    <button
    ...
    <section class="game-resource-row flex min-w-0 translate-y-0.5 items-center justify-end gap-1">
      <div class="game-resource-card flex h-7 w-10 items-center justify-center gap-0 rounded-md bg-stone-950/35 p-0 shadow-[0_4px_12px_rgba(0,0,0,0.35)] backdrop-blur-[1px]">
        <img
      ...
      <div class="game-turn-card grid h-7 w-10 place-items-center rounded-md bg-stone-950/35 p-0 text-center shadow-[0_4px_12px_rgba(0,0,0,0.35)] backdrop-blur-[1px]">
